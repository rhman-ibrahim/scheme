<header>
    <div>
        <h1>Scheme</h1>
        <p><b>Scheme</b> is the name of my boilerplate code which I use to construct my web projects, based on <a href="#python"><b>Python</b></a> (<a href="#django"><b>Django</b></a>/<a href="#drf"><b>DRF</b></a>) for the API development and <a href="#javascript"><b>JavaScript</b></a> (<a href="#react"><b>React</b></a>/<a href="#vite"><b>Vite</b></a>) for the UI development, alongside with <a href="#bash"><b>Bash</b></a> scripts to automate general project tasks.</p>
    </div>
    <div>
        <h2>Here You Will Find</h2>
        <ul>
            <li><a href="https://github.com/rhman-ibrahim/scheme/blob/main/sch.sh" target="_blank"><b>build</b></a> is a bash script that takes the project name (a string) as a parameter, to create <b>Scheme</b> project based on the latest versions of <b>Scheme</b> related repositories.</li>
            <li><a href="https://github.com/rhman-ibrahim/scheme/blob/main/release.sh" target="_blank"><b>download</b></a> is a bash script that takes the project name and the relase tag (both are strings), to create <b>Scheme</b> project based on the chosen release.</li>
        </ul>
    </div>
    <div>
...
<main>
    ...
    <div id="scheme.react">
        <h2>3. scheme.react</h2>
        <p><b>scheme.react</b> repository stores the React and Axios front-end boilerplate code. For more information visit <a href="https://github.com/rhman-ibrahim/scheme.react" target="_blank"><b>scheme.react</b></a>.</p>
        <ul>
    ...
    <div id="scheme.bash">
        <h2>4. scheme.bash</h2>
        <p><b>scheme.bash</b> repository stores general tasks automation scripts which is written with Bash. For more information about the repository vist <a href="https://github.com/rhman-ibrahim/scheme.bash" target="_blank"><b>scheme.bash</b></a>.</p>
        <ul>
